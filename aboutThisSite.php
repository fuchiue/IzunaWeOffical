...
<body>
    ...
    <section id="introPointArea">
        ...
        <div id="right">
            <h2>『 ポイントを貯める 』!!! EXAMPLE CONTENT!!!</h2>
            <p>
                1. 参加してみたボランティアを探す<br>
                まずは自分の興味のあるボランティアを探して見よう！<br>
                いろんな団体やユーザーが開催したボランティアや参加したボランティアについての写真を投稿してくれています。<br>
                きっとあなたも興味を持てるボランティアが見つかります。<br>
                2.ボランティアに応募してみる!<br>
                あなたが興味をもつボランティアを見つけることが出来たら実際に参加してみましょう。<br>
                サイトに登録さえ済めば最短2クリックで簡単に応募する事ができます。<br>
                3.実際にボランティアに参加<br>
                応募が済んだら開催しているボランティア団体からメールが届きます。<br>
                そこで参加決定したらボランティアに実際に参加ということになります。<br>
                4.写真をとろう<br>
                あなたが参加したボランティアの様子をほかのユーザーに知ってもらえるように写真を取って投稿し共有しよう！<br>
                5.ポイントをもらう<br>
                あなたが参加したボランティアの写真を投稿するときに参加したボランティアの活動時間に応じてポイントが付与されます<br>
                ポイントは活動時間1分につき1ポイント付与されます。
